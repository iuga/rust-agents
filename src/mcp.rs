...
struct ChatArguments {
    ...
    id: String,
    #[schemars(description = "The profile or kind of agent you want to talk with: aplha or beta (default: alpha)")]
    profile: String,
    #[schemars(
...
impl MCPServer {
    ...
    async fn chat(
        &self,
        Parameters(ChatArguments { id, profile, message }): Parameters<ChatArguments>,
